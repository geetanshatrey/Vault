# Vault App
<p>
    <img src="GitHub Repo Assets/vaultHeader.png" height="290">
</p>
...
- For example: In the following video, the OTP generated for MyCrypto Wallet is 716528. This is observed from going into the Vault app page.
...
- For example: In the following video, the OTP generated at that moment of time is 504019.
- We then go to the Wallets App page and try to unlock the MyCrypto Wallet.
- But we enter the OTP to be different, in this case 504018. On clicking on Verify, we see an alert overlay in the app asking us to check the OTP again.
